      ...
      <div style={contentStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            VoiceTranslate is a real-time voice translation web application that enables users to translate spoken words and text across 31+ languages. The service is provided on an as-is basis and is subject to these Terms of Service.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            VoiceTranslate offers both account registration (with email or social login) and guest access without creating an account. Guest users may have limitations on storage, history, and feature access compared to registered users.
          </p>
          <p style={paragraphStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            You agree not to use VoiceTranslate for:
          </p>
          <ul style={listStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            VoiceTranslate offers the following subscription tiers:
          </p>
          <ul style={listStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            VoiceTranslate supports the use of your own API keys from third-party AI providers (OpenAI, Anthropic, Google, ElevenLabs). You are responsible for:
          </p>
          <ul style={listStyle}>
          ...
          <p style={paragraphStyle}>
            VoiceTranslate is not responsible for any misuse of your API keys or charges incurred. You assume all risk by providing your API keys.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            You retain ownership of the content you provide for translation. VoiceTranslate retains no exclusive rights to translations generated through the service.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            AI-powered translation may not be 100% accurate. We recommend human review for critical documents, legal contracts, or sensitive communications. VoiceTranslate is not responsible for:
          </p>
          <ul style={listStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            To the fullest extent permitted by Italian law, VoiceTranslate and its creators are not liable for indirect, incidental, special, consequential, or punitive damages, even if advised of the possibility of such damages.
          </p>
          <p style={paragraphStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={paragraphStyle}>
            We may update these Terms of Service at any time. Material changes will be communicated to users via email or a prominent notice on the website. Your continued use of VoiceTranslate constitutes acceptance of the updated terms.
          </p>
        </div>
