  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <button
        ...
        // b.482 — L'INTERRUTTORE SI VEDE UGUALE E SI PRENDE MEGLIO. Il
        // pulsante era alto ventisette: e la misura giusta per il DISEGNO
        // di un interruttore, ma non per un dito. Adesso il bersaglio e
        // alto quarantaquattro e trasparente, e la levetta colorata sta
        // dentro, sempre 48x27. A schermo non cambia niente; cambia quanto
        // e facile prenderlo. Vale per ogni interruttore dell'applicazione,
        // perche questo file e uno solo.
        style={{
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          width: 48, minHeight: 44, flexShrink: 0,
          background: 'transparent', border: 'none', cursor: 'pointer', padding: 0,
          WebkitTapHighlightColor: 'transparent',
        }}>
        <span style={{
          position: 'relative', display: 'block', width: 48, height: 27,
          borderRadius: 999,
