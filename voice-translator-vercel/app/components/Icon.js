...
const paths = {
  ...
  battery: 'M3 7h14a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2zM23 11v2M6 10v4m4-4v4',
  ...
  // b.544 — il cuore del «mi piace». Disegnato come le altre: un tratto
  // solo, che si riempie quando l'icona e accesa (il colore lo decide chi
  // la usa, come per tutte le altre).
  // b.545 — la campana degli avvisi (stile delle altre: un tratto solo).
  ...
  // b.540 — la freccia a sinistra mancava: serve alle frecce della
  // testata del Mondo, che cambiano visuale nei due versi.
  chevLeft: 'M15 18l-6-6 6-6',
  phone: 'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z',
  phoneOff: 'M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67M1 1l22 22M4.22 4.22A19.79 19.79 0 0 0 2.12 4.18 2 2 0 0 0 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91',
  ...
  trophy: 'M8 21h8M12 17v4M7 4h10v6a5 5 0 0 1-10 0V4zM7 6H4a1 1 0 0 0-1 1 4 4 0 0 0 4 4M17 6h3a1 1 0 0 1 1 1 4 4 0 0 1-4 4',
  ...
  // b.208 — icone per i tab di Life (Tavolo = gruppo, Dossier = documento)
  ...
  // b.224 — bersaglio per la scheda "Obiettivi" (tre cerchi concentrici).
