        ...
        <>
          ...
          <div role="dialog" aria-label={tt('linguettaTitle', 'Lingua e voce')}
            ...
            <div style={{ padding: 16, overflowY: 'auto', flex: 1 }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.55)', marginBottom: 8 }}>{tt('voiceTimbre', 'Voce')}</div>
                ...
                {[{ id: 'female', et: `♀ ${tt('femaleWord', 'Femminile')}` }, { id: 'male', et: `♂ ${tt('maleWord', 'Maschile')}` }].map((o) => {
                  ...
                  return (
                    <button key={o.id} onClick={() => cambiaTimbro(o.id)} aria-pressed={on}
                      style={{ flex: 1, padding: '10px 8px', borderRadius: 12, cursor: 'pointer', fontFamily: FONT, fontSize: 13, fontWeight: 500,
              ...
              {onScegliVoce && (
                <button onClick={() => { setAperto(false); onScegliVoce(); }}
                  style={{ width: '100%', padding: '11px 12px', borderRadius: 12, cursor: 'pointer', fontFamily: FONT, fontSize: 13, fontWeight: 500, marginBottom: 18,
              ...
              <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.55)', marginBottom: 8 }}>{tt('spokenLanguage', 'Lingua parlata')}</div>
