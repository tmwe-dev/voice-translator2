          ...
          <div key={i} style={{ padding: '10px 12px', borderRadius: 12, background: 'rgba(255,255,255,0.04)', border: attiva === i ? `1px solid ${accent}` : bordo }}>
            ...
            <div style={{ display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap' }}>
              ...
              <button onClick={() => setAttiva(attiva === i ? -1 : i)}
                style={{ padding: '6px 11px', borderRadius: 9, border: 'none', background: attiva === i ? `${accent}22` : accent, color: attiva === i ? accent : '#04121c', fontWeight: 600, fontSize: 12, cursor: 'pointer', fontFamily: FONT }}>
