    ...
    <div role="dialog" aria-modal="true"
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '12px 14px 0' }}>
          <span style={{ flex: 1, fontSize: 12, fontWeight: 700, color: C.textMuted }}>
            {fontePrima}
          </span>
        ...
        <div style={{ padding: '12px 16px 16px' }}>
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 800, lineHeight: 1.3, color: C.textPrimary, letterSpacing: -0.3 }}>
            {dati.titolo}
          </h2>
          ...
          {tipo === 'articolo' && (
            <div style={{ marginTop: 14, padding: '12px 14px', borderRadius: 14, background: C.card, border: bordo }}>
              <div style={{ fontSize: 10.5, fontWeight: 800, letterSpacing: 1.2, color: C.accent, marginBottom: 6 }}>
                {L('schedaSintesi')}
              </div>
              {sintesiAI ? (
